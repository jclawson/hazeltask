...
public class StaleItemsFlushTask extends TimerTask {
    ...
    protected StaleItemsFlushTask(DistributedExecutorServiceManager manager) {
    ...
    public void run() {
        ...
        TaskExecutorService svc = manager.getDistributedExecutorService();
    ...
    private static class GetOldestTime implements Callable<Long>, Serializable {
        ...
        public Long call() throws Exception {
            LocalTaskExecutorService svc = DistributedExecutorServiceManager
