...
public class HazelcastWorkTest {
    ...
    public void testRunnable() {
        ...
        HazeltaskTask work = new HazeltaskTask(UUID.randomUUID(), "group", null, new Runnable(){
            public void run() {
                value.set(1);
            }
        });
    ...
    public void testCallable() {
        HazeltaskTask work = new HazeltaskTask(UUID.randomUUID(), "group", null, new Callable<Integer>(){
    ...
    public void testHazelcastAwareCallable() {
        ...
        HazeltaskTask work = new HazeltaskTask(UUID.randomUUID(), "group", null, task);
